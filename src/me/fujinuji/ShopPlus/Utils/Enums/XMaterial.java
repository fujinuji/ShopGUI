package me.fujinuji.ShopPlus.Utils.Enums;
...
public enum XMaterial {
    ...
    public static List<Integer> getDataByMaterial(Material material) {
        List<Integer> dataList = new ArrayList<>();
        for (XMaterial xMaterial : XMaterial.values()) {
            if (xMaterial.m.equals(material.name().toUpperCase())) {
                dataList.add(xMaterial.data);
            }
        }
        return dataList;
    }
